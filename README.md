...
| Protected RWA leg (Hedera ATS, `contracts-hedera/`) | Scaffolding in progress. Needs a funded Hedera testnet account (`HEDERA_OPERATOR_ID`/`HEDERA_OPERATOR_KEY`) to actually issue a token. |
